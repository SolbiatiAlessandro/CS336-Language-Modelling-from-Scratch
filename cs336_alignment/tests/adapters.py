...
import cs336_alignment.checkpoint as checkpoint
...
def run_tokenize_prompt_and_output(
    ...
    """
    return checkpoint.tokenize_prompt_and_output(prompt_strs, output_strs, tokenizer)
...
def run_get_response_log_probs(
    ...
    """
    return checkpoint.get_response_log_probs(model, input_ids, labels, return_token_entropy)
